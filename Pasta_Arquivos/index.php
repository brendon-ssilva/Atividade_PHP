...
<body>
  ...
  <section id="sobre" class="hero">
    <div>
      ...
      <button class="btn" onclick="scrollToComprar()">Garanta o Seu Agora</button>
    </div>
    <div>
  ...
  <section class="exclusivo">
    ...
    <button class="btn" onclick="scrollToComprar()">Comprar Agora</button>
  </section>
  ...
  <section id="comprar" class="comprar">
    ...
    <?php else: ?>
      <a href="esgotado.html" style="text-decoration: none;">
        <button class="btn" type="button" style="background: #555; cursor: pointer;">
          Esgotado
        </button>
      </a>
    <?php endif; ?>
